...
#ifndef FREERTOSCONFIG_H__
#define FREERTOSCONFIG_H__
...
// The NRF52 supports 8 priority levels so the mask will be 0xE0
#define configPRIO_BITS 3

// should be set to the lowest possible priority
#define configKERNEL_INTERRUPT_PRIORITY (7 << (8 - configPRIO_BITS))

// Any interrupts dealing with FreeRTOS must operate at a lower
// priority (higher number) than this
